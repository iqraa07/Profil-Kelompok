...
- [Preview Aplikasi](#-preview-aplikasi)
  - [1. Intro Aplikasi](#1-intro-aplikasi)
  - [2. About – Profil Kelompok](#2-about--profil-kelompok)
  - [3. About – Ringkasan Informasi](#3-about--ringkasan-informasi)
  - [4. Skills – Kemampuan Tim](#4-skills--kemampuan-tim)
  - [5. Contact – Hubungi Kami](#5-contact--hubungi-kami)
- [Anggota Kelompok](#-anggota-kelompok)
- [Fitur Utama Aplikasi](#-fitur-utama-aplikasi)
- [Tech Stack Singkat](#️-tech-stack-singkat)
...
<p align="center">
  <img src="docs/01_intro_aplikasi.png" alt="Intro Aplikasi" width="320" />
</p>

Halaman pembuka yang menjelaskan:

- Ringkasan aplikasi dan teknologi yang digunakan  
  (Navigation Component + Jetpack Compose + Material 3 Scaffold).
...
<p align="center">
  <img src="docs/02_about_profil_kelompok.png" alt="About – Profil Kelompok" width="320" />
</p>
...
- Card **“Tentang Kelompok & Aplikasi”** yang menjelaskan konteks tugas dan teknologi:
  - Scaffold, TopAppBar, Bottom Navigation, Floating Action Button (FAB),
    dan integrasi Fragment + Compose.
...
<p align="center">
  <img src="docs/03_about_ringkasan_informasi.png" alt="About – Ringkasan Informasi" width="320" />
</p>
...
<p align="center">
  <img src="docs/04_skills_kelompok.png" alt="Skills – Kemampuan Tim" width="320" />
</p>
...
<p align="center">
  <img src="docs/05_contact_ketua.png" alt="Contact – Hubungi Kami" width="320" />
</p>
...
- **ProfileApp (Jetpack Compose + Material 3)**
  - `Scaffold` dengan:
    ...
    - `NavigationBar` (tab **About**, **Skills**, **Contact**).  
    - FAB:
...
- **Min SDK**: 24  
- **Theme**: Light / Dark dengan `MaterialTheme`, `lightColorScheme()` & `darkColorScheme()`
...
1. **Clone repository**
   ...
   ```bash
   git clone https://github.com/iqraa07/profil-kelompok-sesi6.git
   cd profil-kelompok-sesi6
